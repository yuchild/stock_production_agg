...
def main():
    ...
    - Stop Loss Price: Price to set for stop loss based on entry (last) price and max loss amount
    - Take Profit Price: Price to set for take profit based on last price and 2x max loss amount above entry price
    """)
